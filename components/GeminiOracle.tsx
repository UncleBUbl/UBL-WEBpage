...
const GeminiOracle: React.FC = () => {
  ...
  // If no API key is present, this section renders a static version gracefully
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Simulate a brief "processing" pause for effect before hitting API
    setTimeout(async () => {
  ...
  return (
    <section className="py-32 px-6 relative bg-zinc-900 overflow-hidden">
